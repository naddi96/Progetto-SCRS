...
/*			console.log('\n--> Submit Transaction: InitLedger, function creates the initial set of assets on the ledger');
			var result = await contract.submitTransaction('ReadAuto',"1");
			console.log('*** Result: committed');
...
*/
		...
		*/
			...
			var result = await contract.evaluateTransaction('GetAllOwner');
			console.log(`*** Result: ${result.toString()}`);

			console.log('\n--> Evaluate Transaction: GetAllCars, function returns all the current assets on the ledger');
			result = await contract.evaluateTransaction('GetAllCars');
			...
			evaluateTransaction('Trasferisci',/*aquirente*/"1", /*venditore*/"3",  /*macchina*/"4");
			console.log(`*** Result: ${(result.toString())}`);
